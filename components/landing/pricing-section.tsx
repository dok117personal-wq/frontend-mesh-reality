    ...
    <section id="pricing">
      <div className="container mx-auto max-w-5xl py-10">
        <div className="mx-auto space-y-4 py-6 text-center">
          <h4 className="mx-auto mb-2 max-w-3xl text-balance text-4xl font-medium leading-none tracking-tighter bg-gradient-to-br dark:from-white from-black from-30% dark:to-white/40 to-black/40 bg-clip-text text-transparent pb-2 sm:text-5xl md:text-6xl lg:text-7xl">
            Simple pricing for everyone.
          </h4>
        </div>
        <p className="text-center text-xl leading-8 text-muted-foreground">
